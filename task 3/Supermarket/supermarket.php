  ...
  <div class="container">
    <div class="row">
      <form class="col-5 offset-3 " method="post">
        <h1 class="text-center text-success mt-5">Supermarket</h1>
        <div class="mb-3">
        ...
        ?>
          ...
          <button type="submit" class="btn btn-success mt-3 col-12">Receipt</button>
        <?php } ?>
      ...
      ?>
        <div class="card border-success mb-3 mt-5">
          ...
          <div class="card-footer bg-transparent border-success"><?= "<strong>Net Total : </strong>" . $totalAfterDiscount + $fees . " EGP";
                                                                } ?></div>
        </div>
